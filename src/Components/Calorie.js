...
const Calorie = () => {
  ...
  const onSubmit = data => {
    ...
    if (gender === 'male') setCalorie(10 * weight + 6.25 * heightInCm - 5 * age + 5);
    else setCalorie(9.247 * weight + 3.098 * heightInCm - 4.33 * age + 447.593);
  }
  return (
    <div className='w-full '>
      <h1 className='text-3xl md:text-4xl font-bold mb-0 text-center mt-10'>Calculate Calorie</h1>
        ...
        <div className='w-full md:w-1/2 pl-0 md:pl-6 mt-8 md:mt-0'>
          <div id='result' className='h-full w-full rounded-lg border-2 border-gray-200 bg-gray-100 shadow-lg'>
            ...
            <div className='w-full h-full p-8'>
              <h1 className='font-semibold text-lg mb-2'>Calorie : <span className='font-bold '>{calorie.toFixed(1)}</span> calories/day</h1>
            </div>
          </div>
        </div>
      </div>
